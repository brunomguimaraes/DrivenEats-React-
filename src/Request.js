...
export default function Request ({dishes, drinks, desserts, total, esconderEsconderPedido, esconder}) {
    return (
...
function Encaminhar(dishes, drinks, desserts, total){
  ...
  window.location.href = "https://wa.me/5592993593563?text=" + encodeURIComponent(mensagem_padrão);
}
